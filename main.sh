...
echo ::group:: Installing Sphinx and Sphinx-PDF Generate extension
...
echo Installing Sphinx-PDF Generate via pip
pip3 install -U sphinx-pdf-generate
...
echo ::group:: Running Sphinx-PDF Generate builder
